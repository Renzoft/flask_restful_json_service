    ...
    if Producto.query.count() == 0:
        productos = [
            ...
            Producto(
                ...
                descripcion="Monitor IPS Full HD con bordes delgados",
            ...
            Producto(
                ...
                descripcion="Mouse inalámbrico USB básico",
                categoria="Periféricos",
                precio=65.00,
                stock=25
            ),
            ...
            Producto(
                nombre="Audífonos Sony con Cancelación de Ruido",
                descripcion="Auriculares Bluetooth ideales para oficina",
                categoria="Audio",
                precio=350.00,
                stock=10
            ),
